...
export const learnContent: Record<TopicId, LearnTopic> = {
  credit: {
    ...
    subhead:
      "What a credit score actually is, what moves it, and how to build one from zero — in plain English.",
    intro: [
      "Your credit score is just a number that tells lenders how likely you are to pay back what you borrow. It quietly shapes whether you can rent an apartment, finance a car, or get a phone plan without a big deposit — and yet almost no one sits you down to explain how it works.",
      "Here's the whole picture, start to finish: what builds a score, what dents it, and how to start from nothing.",
    ],
        ...
        items: [
          {
            ...
            blurb:
              "The five things that make up your score — and which ones actually matter most.",
          },
          {
  ...
  budgeting: {
    ...
    subhead:
      "Not a spreadsheet that makes you feel bad — a simple plan for where your money goes.",
    intro: [
      "A budget isn't a restriction; it's a decision you make once so you don't have to stress about money every single day. It's permission to spend on what matters, because you already know the essentials are covered.",
      "Whether your income is steady, seasonal, or all over the place, there's a way to build a plan that works for you — not against you.",
    ],
    level: "Beginner-friendly",
    path: [
      {
  ...
  taxes: {
    ...
    intro: [
      "Taxes feel intimidating mostly because no one explains them. But for most people starting out, filing is more straightforward than it looks — and it often means money coming back to you, not out of you.",
      "Let's walk through the forms, the deadlines, and the free ways to get it done right.",
    ],
    level: "Beginner-friendly",
    path: [
      {
  ...
  college: {
    ...
    subhead: "FAFSA, financial aid, scholarships, and loans — decoded.",
    intro: [
      "The price on a college's website is rarely what you actually pay. Between FAFSA, grants, scholarships, and aid, there's a whole system built to close the gap between sticker price and what a family can really afford.",
  ...
  investing: {
    ...
    intro: [
      "Investing isn't only for people with money to spare — it's how money grows faster than it can sitting in a savings account. You can start with small amounts, and the most important ingredient is time, not a big balance.",
  ...
  "home-ownership": {
    ...
    intro: [
      "Owning a home is one of the biggest financial moves you'll ever make — and one of the most mythologized. Here's what the words actually mean and how to tell if you're ready, without the sales pitch.",
  ...
  "government-aid": {
    ...
    intro: [
      "Government programs exist for exactly the moments life gets hard — between jobs, low income, medical bills, overwhelming debt. There's no shame in using them; they're built for this. The hard part is usually just knowing they're there.",
      "We'll map out what's available and how to actually apply, in language that respects you.",
    ],
    level: "Beginner-friendly",
    path: [
      {
  ...
  "money-safety": {
    ...
    intro: [
      "Scammers don't target people because they're careless — they target people who are busy, hopeful, or under pressure, which is all of us at some point. The tactics are designed to rush you past your better judgment, and they work on smart people every single day.",
      "The good news: almost every scam waves the same few red flags, and most of your best defenses are free. Learn the patterns once and you'll spot them coming for the rest of your life.",
    ],
    level: "Beginner-friendly",
    tool: { label: "Budget Planner", href: "/tools/budget" },
  ...
  insurance: {
    ...
    subhead:
      "What premiums, deductibles, and copays actually mean — and how to pick coverage that fits your life and budget.",
    intro: [
      "Insurance is one big idea wrapped in confusing words: you pay a little, regularly, so that a disaster you couldn't afford on your own doesn't wipe you out. The catch is that nobody explains the vocabulary — premium, deductible, copay — so it's easy to overpay, or to skip coverage you actually need.",
