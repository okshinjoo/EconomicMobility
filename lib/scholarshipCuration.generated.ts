...
// Records that failed or still need manual review remain preserved in the
// source catalog. Owner-approved amount-floor exceptions are published while
// the other unresolved records stay out of the public Finder.
...
export const SCHOLARSHIP_MANUAL_REVIEW_WITHHELD =
  SCHOLARSHIP_AUDIT_MANUAL_REVIEW - SCHOLARSHIP_AMOUNT_FLOOR_EXCEPTION_COUNT;
export const SCHOLARSHIP_PUBLIC_TOTAL =
  SCHOLARSHIP_AUDIT_PASSED + SCHOLARSHIP_AMOUNT_FLOOR_EXCEPTION_COUNT;
...
> = {
  ...
  "microsoft-disability-scholarship": {
    ...
    deadlineMonth: null,
    who: "Current high school seniors entering eligible U.S. two-year, four-year, or vocational or technical study; Scholarship America and Microsoft's FAQ do not require disability, while Seattle Foundation still says applicants must live with a disability, so confirm this conflicting requirement before applying.",
  },
  ...
  "md-collins-honor-iii-leadership": {
    ...
    deadlineMonth: null,
    who: "Eligible undergraduate and graduate ROTC students at Bowie State, Coppin State, Morgan State, or UMES; recipients must meet the program's full-time enrollment rule.",
