...
export const communityQuestions: CommunityQA[] = [
  {
    ...
    answer: [
      ...
      "Then keep two habits boringly consistent: pay the full balance on time every month, and keep what you owe well below your limit. There's no secret fast-track — anyone promising to “boost” your score for a fee is selling something you can do yourself for free.",
    ],
    topic: "credit",
  ...
  },
  {
    ...
    answer: [
      "Not at all — and you don't have to be unemployed to qualify. Plenty of people who work full time still qualify, especially with kids or high rent. These programs are funded by taxes, including ones taken out of your own paychecks, so using them is you accepting help that was built for exactly your situation.",
  ...
  },
  {
    ...
    answer: [
      ...
      "The real test isn't a percentage — it's whether, after rent, you can cover your other needs, chip at any debt, and save even a little. If rent leaves nothing for those, that's the signal to adjust.",
    ],
    topic: "budgeting",
