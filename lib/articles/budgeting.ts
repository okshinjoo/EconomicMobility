...
export const budgetingArticles: Article[] = [
  {
    ...
    dek: "Not a spreadsheet that judges you — just a plan that finally tells you where your money goes.",
    level: "Beginner",
    readMinutes: 6,
    takeaways: [
    ...
    body: [
      ...
      {
        type: "p",
        text: "Here's the first thing that trips people up. The number on your job offer — your salary — is not the money you get. After taxes and other deductions, what's left is your net income, your take-home pay. That smaller number is what you build a budget on, because it's what you actually have.",
      },
      {
        type: "tip",
      ...
      {
        type: "p",
        text: "Pull up your last month of bank and card activity. No judgment — just look. You're sorting everything into two piles. Fixed costs stay about the same every month; variable costs jump around.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "p",
        text: "Don't aim for perfect. Round to the nearest ten bucks and keep moving. The point isn't a flawless ledger — it's noticing patterns you've never actually looked at.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Now match your money to your life *on purpose*, ahead of time. A simple place to start is the 50/30/20 rule — roughly half your take-home for needs, 30% for the stuff that makes life good, and 20% toward savings and paying down debt. It's a starting point, not a law. Bend it to fit you.",
      },
      {
        type: "p",
...

  {
    ...
    takeaways: [
      ...
      "Wants aren't the enemy — unplanned wants are.",
      "The goal is fewer money regrets, not fewer good times.",
    ],
    body: [
      {
        type: "p",
        text: "Almost every budget asks you to split your spending into needs and wants. Sounds easy — until you're staring at your daily coffee, or the money you send to your family, or the gym membership you swear you'll use, wondering which pile any of it goes in. Let's make this simple, and drop the guilt while we're at it.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Once your spending is sorted, a framework like the 50/30/20 rule suddenly clicks, because you already know which dollars are which.",
      },
    ],
...

  {
    ...
    body: [
      {
        type: "p",
        text: "If you only remember one budgeting idea, make it this one. The 50/30/20 rule is famous because it's almost impossible to mess up — it sorts your money into just three buckets, and you can do the math in your head.",
      },
      {
        type: "h2",
        text: "How it works",
      ...
      },
      {
        type: "list",
        items: [
          "**50% — Needs:** rent, utilities, groceries, getting around, insurance, minimum debt payments.",
          "**30% — Wants:** going out, hobbies, subscriptions, travel, the good stuff.",
          "**20% — Future you:** building an emergency fund, investing, and throwing extra at debt.",
        ],
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "Real talk: in a lot of cities, rent alone eats way more than 50% of take-home. If that's you, you're not failing the rule — the rule just needs to flex. Maybe it's 60/20/20 right now, or 50/20/30 while you're crushing a debt. Maybe part of your 30% goes to family instead of fun. The exact split matters less than the fact that you *have* one.",
      },
      {
        type: "tip",
...

  {
    ...
    dek: "Gig work, tips, commissions, seasonal jobs — here's how to budget when no two months match.",
    level: "Intermediate",
    readMinutes: 6,
    takeaways: [
    ...
    body: [
      ...
      {
        type: "tip",
        text: "A high-yield savings account is a great home for that buffer — your money stays available the moment you need it, but it earns a little interest while it waits.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "On a rough month, the order you pay things in matters more than anything. Make a ranked list of your fixed costs and work straight down it:",
      },
      {
        type: "steps",
        items: [
          "Housing and utilities — keep a roof and the lights first.",
          "Food and getting around — what you need to live and earn.",
          "Insurance and minimum debt payments — protect yourself and your credit.",
          "Everything else — once the essentials are safe.",
        ],
      },
      {
        type: "h2",
      ...
      {
        type: "key",
        text: "Irregular income isn't a dealbreaker. You just plan for the valleys and treat the peaks as opportunities — not as spending money that fell from the sky.",
      },
    ],
...

  {
    ...
    body: [
      {
        type: "p",
        text: "You made a budget. You *meant* it. Three weeks later you're over in two categories, a little annoyed at yourself, wondering why you even bother. First: this is incredibly common, and it almost never means you lack discipline. It usually means the budget needs a tune-up.",
      },
      {
        type: "h2",
      ...
      {
        type: "h2",
        text: "It's almost always one of these two things",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "Add a real 'fun' line and a small cushion for surprises. A budget with a little slack survives a bad week. A budget stretched to the last dollar snaps the first time your car needs a part or a friend has a birthday.",
      },
      {
        type: "tip",
...

  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Setting a limit doesn't mean you love anyone less. It means you're planning to be there for the long haul — which is its own kind of devotion.",
      },
    ],
    related: ["budgeting-irregular-income", "fixing-a-broken-budget", "sinking-funds"],
  },

  {
    ...
    dek: "Checking, savings, and how to dodge the fees designed to nickel-and-dime you.",
    level: "Beginner",
    readMinutes: 5,
    takeaways: [
      "Checking is for spending; savings is for keeping.",
      "The right account charges you nothing to hold your money.",
      "Watch for overdraft and minimum-balance fees especially.",
      "You usually need an ID and a little cash to start.",
    ],
    body: [
      {
        type: "p",
        text: "A bank account sounds like the most basic thing in the world — until it's your first one, nobody walked you through it, and the bank's website is a wall of fine print. If keeping your money in cash or on a prepaid card is what you know, that's okay. Here's the plain version of how this works.",
      },
      {
        type: "h2",
      ...
      },
      {
        type: "list",
        items: [
          "**Checking** is your day-to-day account — paycheck goes in, you spend from it with a debit card, pay bills, get cash.",
      ...
      {
        type: "h2",
        text: "The fees to watch for",
      },
      {
        type: "p",
        text: "Here's the part nobody warns you about. A good account costs nothing to hold your money. But some accounts are built to charge you, and the fees hit people with low balances the hardest. Look out for:",
      },
      {
        type: "list",
        items: [
          "**Monthly maintenance fees** — a charge just to have the account. Plenty of banks waive these; find one that does.",
          "**Overdraft fees** — $30+ for spending a few dollars you didn't have. Turn overdraft *off* so a card just gets declined instead.",
          "**Minimum-balance fees** — a penalty for dropping below some number. Skip any account that does this if money is tight.",
        ],
      },
      {
        type: "tip",
      ...
      {
        type: "p",
        text: "It's usually quick — online or in person. You'll generally need a government photo ID, your Social Security number or ITIN, an address, and a small amount to deposit. Some banks have options designed for students or for people without traditional documents, so it's worth asking.",
      },
      {
        type: "key",
        text: "The right first account is boring in the best way: it holds your money, charges you nothing, and quietly makes everything else — budgeting, saving, getting paid — easier.",
      },
    ],
    related: ["building-your-first-budget", "sinking-funds", "needs-vs-wants"],
  },

  {
    ...
    body: [
      {
        type: "p",
        text: "Car repairs. The holidays. The insurance bill that lands once a year. New tires. We call these 'unexpected,' but let's be honest — you knew they were coming. A sinking fund is the quiet little trick that turns these budget-wreckers into a shrug.",
      },
      {
        type: "h2",
      ...
      },
      {
        ...
        items: [
          ...
          "Set a small automatic transfer for each, ideally into a high-yield savings account.",
      ...
      {
        type: "key",
        text: "Sinking funds are how people on totally normal incomes seem to never get rattled by a big bill. They're not lucky — they saw it coming and quietly saved a little each month.",
      },
    ],
    related: ["budgeting-irregular-income", "fixing-a-broken-budget", "money-and-family"],
  },
];
