...
export const budgetingEarningArticles: Article[] = [
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Here's the thing that surprises almost everyone with their first paycheck: it's smaller than they expected. The salary or hourly rate you were promised is the number *before* taxes and other deductions come out. What's left — what actually lands in your account — is your take-home pay, and that's the number your whole plan runs on.",
      },
      {
        type: "p",
      ...
      {
        type: "tip",
        text: "If the deductions look confusing, you're not missing something obvious — pay stubs are genuinely cryptic the first few times. Our guide on reading a pay stub breaks every line down in plain language.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Once needs are covered, divide what's left in a way that builds a good habit early. A clean starting point is a simple three-way split of your take-home: most of it for needs, a chunk for the things that make life good, and a slice for savings. The exact percentages matter less than the *order*.",
      },
      {
        type: "key",
      ...
      {
        type: "p",
        text: "That cushion has a name worth knowing: an emergency fund. It's money set aside for the day something goes wrong — a car repair, a missed shift, a surprise bill. Starting one now, while you can, means a bad week never turns into a debt you spend a year digging out of.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Here's the trap that quietly catches people for *years*. When your income goes up — a raise, a better job, more hours — your spending tends to rise right along with it. A nicer apartment, better takeout, the upgraded phone. It feels earned, and a little of it is fine. But if spending always rises to swallow every raise, you can make a lot more money over time and somehow never feel any further ahead. That's *lifestyle inflation*, and it's beaten by one move: when your income jumps, send some of the increase to savings *before* you get used to spending it.",
      },
      {
        type: "p",
        text: "You don't have to get any of this perfect with your first paycheck. Cover what matters, save a little, and stay aware of where it's going. Do that, and you've already built the habits that make every paycheck after this one easier.",
      },
    ],
...

  {
    ...
    takeaways: [
      ...
      "Benefits — health insurance, retirement, time off — have real dollar value.",
    ...
    body: [
      ...
      {
        type: "key",
        text: "An employer 401(k) match is as close to free money as it gets. If your job adds, say, fifty cents for every dollar you contribute up to some limit, that's an instant return on your own savings — money you walk away from if you don't contribute enough to get the full match. When you can, contribute at least enough to grab all of it.",
      },
      {
        type: "h2",
      ...
      },
      {
        ...
        items: [
          ...
          "Real costs of the job — a long commute, required equipment, or a city where everything costs more.",
        ],
      },
      {
        type: "tip",
        text: "Don't try to do the tax math in your head. Pay is taxed before it reaches you, and the after-tax difference between two salaries is smaller than the gap looks. Lean on a take-home estimator and our pay-stub guide instead of guessing.",
      },
      {
        type: "h2",
...

  {
    ...
    body: [
      {
        type: "p",
        text: "For a lot of people, asking for a raise feels almost physically impossible. If you grew up being told to keep your head down, be grateful for what you have, and not make a fuss, walking into your boss's office to ask for more money can feel terrifying — even rude. So let's say the most important thing first: asking is normal. Employers expect it. It is part of how working actually works, and getting good at it can be worth more over a career than almost any other money skill.",
      },
      {
        type: "key",
        text: "Asking for a raise is not greedy. You're not demanding a favor — you're asking to be paid fairly for work you're already doing. The worst realistic outcome is a 'not right now,' which is just information you can use.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Then — this is the hard part — stop talking and let them respond. Silence feels uncomfortable, but it's not your job to fill it. Stay calm, stay friendly, and let them think.",
      },
      {
        type: "tip",
      ...
      {
        type: "p",
        text: "You will not always get a yes, and that's okay. But you almost never get what you don't ask for, and the asking gets less scary every single time you do it. Prepare, stay calm, and treat it as the completely normal conversation it actually is.",
      },
    ],
    related: ["reading-a-job-offer", "managing-financial-stress", "your-first-paycheck"],
  },

  {
    ...
    takeaways: [
      ...
      "Side income is taxable with nothing withheld — set some aside.",
    ],
    body: [
      {
        type: "p",
        text: "The internet is loud about side hustles. Everywhere you look, someone's promising you can replace your income from your couch, be your own boss, and quit your job by next quarter. Some of that is real. A lot of it is a sales pitch. This is the honest version — no hype, no get-rich-quick energy — about how people actually earn a little extra, how to spot the traps, and the one boring detail almost nobody warns you about.",
      },
      {
        type: "h2",
      ...
      {
        type: "key",
        text: "Here's the honest part: almost all real side income trades your time for money. That's not a knock on it — it's just the truth. A side hustle can ease a tight stretch or fund a goal, but it usually won't fix a budget that doesn't add up. The math underneath still has to work.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Where there's people wanting extra money, there are people trying to take it. The pitches dressed up as 'opportunities' often follow the same patterns. Be very skeptical when you see these:",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "p",
        text: "Here's the detail that catches people off guard, and it's important: money you earn from a side hustle or gig work is taxable income — but unlike a regular paycheck, *no taxes are taken out for you*. With a normal job, taxes come out before you ever see the money. With side income, the full amount hits your account, and you're responsible for the taxes on it later.",
      },
      {
        type: "p",
        text: "That trips up a lot of first-time gig workers, who spend it all and then owe a chunk at tax time. The fix is simple: every time you get paid, set aside a portion in savings so the bill doesn't blindside you. The exact share depends on your situation, and the rules around self-employment income are their own subject — so we won't try to cram them in here.",
      },
      {
        type: "p",
        text: "Instead, before your side income gets going, read our guides on self-employment and gig taxes. They walk through how much to set aside, what to track, and how to handle it properly — so the extra money you worked for stays a win and doesn't turn into a surprise.",
      },
      {
        type: "p",
