...
export const freshness: FreshnessEntry[] = [
  {
    ...
    lastVerified: "July 18, 2026. TWO vintages by design: the original 100 carry May 2025 OEWS pay (31 with the verified payLow/payHigh/numJobs range, 69 pending the API-quota backfill). WAVES 1–6 added 302 careers (100 → 402, comprehensive) from the BLS Employment Projections table (2024 wage + 2024–34 growth/openings/education) — their May 2025 pay range backfills from the OEWS API later. annualOpenings (2024–34 avg) was added for all via the EP table. Cards/pages show an em dash where a range is still pending; top-coded medians render as \"$239,200+\" via payLabel(). Wave 6 was a full line-by-line pass over all 832 EP SOCs catching the last distinct searchable careers. 402 is the honest endpoint — remaining uncovered SOCs are genuine padding (machine-operator-by-material variants, professor-by-subject, first-line-supervisor-of-X, clerk/aide sub-variants) or lack an honest annual wage (actors/musicians/military — deliberately excluded).",
