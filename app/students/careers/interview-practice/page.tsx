...
export const metadata: Metadata = {
  ...
  description:
    "Fourteen questions interviewers actually ask, as flip cards: see the question, say your answer out loud, flip for what a strong answer contains. Free, no signup.",
};
      ...
      <section className="relative overflow-hidden border-b-2 border-ink bg-forest text-cream">
        <HeroRecede className="mx-auto max-w-6xl px-6 py-12 lg:py-16">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-cream/75">
            Fourteen questions that show up in nearly every first-job
