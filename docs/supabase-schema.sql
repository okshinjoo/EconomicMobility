...
-- ============================================================
-- PROFILE PICTURES (July 16, 2026) — run this block once.
-- Optional member avatars: an avatar_url column on profiles and
-- a public-read `avatars` storage bucket. Each member owns one
-- object (avatars/<user id>/avatar.jpg), replaced in place; the
-- app square-crops + downscales to 256px before upload. The app
-- tolerates the column being absent (saves retry without it).
-- ============================================================
alter table public.profiles
